...
import { DataBaseAnimals, HumanDataBase, PlantDataBase } from "../image/BruhDataBase.js";
...
export class startElements{
    ...
    public createStarterPack(plantDataBase: PlantDataBase, animalDataBase: DataBaseAnimals, humanDataBase: HumanDataBase, map: SimulationMap){
    ...
    private createAnimalStarterPack(dataBase: DataBaseAnimals, map: SimulationMap){
      ...
      const HumanTypeArray: HumanType[] = [HumanType.Human];
  ...
  private createHumanStarterPack(dataBase: HumanDataBase, map: SimulationMap){
      ...
      HumanTypeArray.forEach((type) => {
        const data = {
          [type]: new Human(
            ...
            HumanType[type as keyof typeof HumanType]
          )
        };
        dataBase.addObject(data[type]);
      });
